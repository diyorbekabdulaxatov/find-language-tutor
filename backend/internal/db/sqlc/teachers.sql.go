...
SELECT id, slug, display_name, headline, kind, country_code, country_name, city, timezone, price_per_hour_minor, trial_price_minor, currency, rating, review_count, lessons_completed, student_count, response_time_hours, accepting_students, avatar_url, video_thumbnail_url, intro_video_url, about, teaching_style, created_at, updated_at, user_id, meeting_url, status, verified, moderation_note, rating_base, review_count_base, avatar_asset_id, intro_video_asset_id FROM teachers WHERE slug = $1
`
