...
const PAGE_SIZE = 20;
const FILTERS: { value: "" | TeacherStatus; label: FilterKey }[] = [
  { value: "", label: "filterAll" },
  { value: "pending", label: "filterPending" },
  { value: "approved", label: "filterApproved" },
  { value: "suspended", label: "filterSuspended" },
  { value: "rejected", label: "filterRejected" },
];
type FilterKey = "filterAll" | "filterPending" | "filterApproved" | "filterSuspended" | "filterRejected";
