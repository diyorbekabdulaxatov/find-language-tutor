            ...
            <table className="w-full text-sm">
              <thead className="bg-muted text-left text-xs text-muted-foreground">
                <tr>
                  ...
                  <th className="px-4 py-2.5 font-bold">{t("colClearedSince")}</th>
        ...
        {batches.length === 0 ? (
          ...
          <div className="overflow-hidden border border-border">
            <table className="w-full text-sm">
              <thead className="bg-muted text-left text-xs text-muted-foreground">
                <tr>
                  <th className="px-4 py-2.5 font-bold">{t("colRun")}</th>
                  <th className="px-4 py-2.5 font-bold">{t("colBy")}</th>
                  <th className="px-4 py-2.5 font-bold">{t("colTeachers")}</th>
                  <th className="px-4 py-2.5 font-bold">{t("colLessons")}</th>
                  <th className="px-4 py-2.5 text-right font-bold">{t("colTotal")}</th>
                  <th className="px-4 py-2.5 text-right font-bold">{t("colStatus")}</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-border">
                {batches.map((b) => (
...
function RunPayoutCard({
  ...
  return (
    <div className="border border-primary/30 bg-primary/5 p-5">
      {result ? (
        <p className="text-sm">
          <span className="font-bold text-primary">{t("done")}</span> {result}
        </p>
      ) : !confirming ? (
...
function Stat({
  ...
  return (
    <div
      className={cn(
        "border p-4",
        accent ? "border-foreground bg-accent" : "border-border bg-card",
      )}
    >
